...
abstract class $NameCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String first, String family});
}
...
class _$_Name implements _Name {
  const _$_Name({required this.id, required this.first, required this.family});
  ...
  @override
  String toString() {
    return 'Name(id: $id, first: $first, family: $family)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, first, family);
...
abstract class _Name implements Name {
  const factory _Name(
      ...
      required final String family}) = _$_Name;
